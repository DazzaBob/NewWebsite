...
namespace Website.Pages.modals
{
    ...
    public class WelcomeBackModel : PageModel
    {
        ...
        public IActionResult OnPost()
        {
            ...
            sb.Append($"<div class=\"custom-modal\" data-modal-type=\"modalwelcomeback\" data-modal-id=\"{modalId}\">")
              .Append("<div class=\"custom-modal-content\" role=\"dialog\" aria-modal=\"true\" aria-labelledby=\"modalwelcomebackmodaltitle_@modalId\">")
              ...
              .Append("<button id='ModalwelcomeOk' class='btn btn-primary'>OK</button>")
              .Append("</div>")
              .Append("</div></div></div>");
